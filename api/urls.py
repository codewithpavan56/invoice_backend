...
urlpatterns = [
    ...
    path('clients/', views.clients_list_create),
    path('clients/<str:client_id>', views.client_detail, name='client_detail'),
    path('clients/<str:client_id>/', views.client_detail),
